...
n_coeff = size(sig{1,1},1);                             %number of coefficients in cluster wave function.
...
cin(range) = sig{y,2}*cin(range);                       %Lowering operator on site i works on the wave function of the respective cluster.
c = cin;
